package com.booklapp.controller;
...
import com.booklapp.service.BookService;
...
public class BookController {
	...
	@GetMapping("/")
	public String home(@ModelAttribute("message")String message,ModelMap model) {
		String msg=message;
	...
	public String deleteBook(@ModelAttribute Book book ,BindingResult res,Model model) {
		if(res.hasErrors()) {
